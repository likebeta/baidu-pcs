...
class BaiduPcs(object):
    ...
    def __rapidupload(self):
        ...
        params = {
            ...
            'ondup': 'overwrite',
            'content-length': sz,
            'content-md5': get_file_md5('', self.args.local_path),
            'content-crc32': get_file_crc32('', self.args.local_path),
        }
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='It is a command-line tool to operate baidu pcs')
